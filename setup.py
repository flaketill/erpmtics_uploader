...
application_title = "erpmtics_uploader" #application to be called
...
setup(
    ...
    ,download_url='http://artpcweb.appspot.com/projects/erpmtics/erpmtics_uploader'
    ,zip_safe=False
    ,entry_points = 
    {
        'console_scripts': [
            'erpmtics_uploader = erpmtics_uploader.app:main'
        ]
